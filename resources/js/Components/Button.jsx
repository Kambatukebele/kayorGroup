...
const Button = ({ btnText, href }) => {
    return (
        <Link
            href={href}
            className="text-white bg-blue-700 w-fit text-center px-6 py-3 rounded-lg hover:bg-blue-900 duration-300 ease-in-out flex justify-center items-center gap-4"
        >
